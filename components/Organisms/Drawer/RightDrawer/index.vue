<template>
  ...
  >
    ...
    <div>
      <p class="darkest text-white py-1 pl-4 text-body-2 font-weight-bold mb-0">
        お葬式をご検討中のお客様
      </p>
      <div class="d-flex justify-space-around row-content">
        <div class="col-content">
          <v-btn class="py-5 ml-2" :href="$to('/membership/')" text height="22">
            ...
            <span class="text-black">よりそう会員とは</span>
          </v-btn>
        </div>
        <div class="col-content">
          <v-btn class="py-5 ml-2" text href="/login/" height="22">
            <v-icon class="mr-4" size="16">fa-caret-right</v-icon>
            <span class="text-black">会員ログイン</span>
          </v-btn>
        </div>
      </div>
...
export default defineComponent({
  setup() {
    ...
    const funeralPlanMenus = funeralStore.state.funeralPlans;
